// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\individual4_block.v
...
// -------------------------------------------------------------
// 
// Module: individual4_block
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array1/individual4
// Hierarchy Level: 4
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module individual4_block
  ...
  Subsystem_block7 u_Subsystem (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
  ...
  Subsystem1_block6 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem2_block6 u_Subsystem2 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem3_block6 u_Subsystem3 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem4_block6 u_Subsystem4 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem5_block6 u_Subsystem5 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block6 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
