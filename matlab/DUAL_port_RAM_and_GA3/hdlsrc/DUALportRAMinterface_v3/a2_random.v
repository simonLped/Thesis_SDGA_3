// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\a2_random.v
...
module a2_random
  ...
  wire signed [18:0] Add_sub_cast;  // sfix19_En15
  wire signed [18:0] Add_sub_temp;  // sfix19_En15
  ...
  assign Add1_out1 = Data_Type_Conversion2_out1 + 17'sb10000001100110011;
  ...
  assign Add_sub_cast = {{2{Data_Type_Conversion2_out1[16]}}, Data_Type_Conversion2_out1};
  assign Add_sub_temp = 19'sb1110000001100110011 - Add_sub_cast;
