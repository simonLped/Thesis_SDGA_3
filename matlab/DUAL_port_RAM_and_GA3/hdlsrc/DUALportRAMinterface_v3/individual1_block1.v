// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\individual1_block1.v
...
// -------------------------------------------------------------
// 
// Module: individual1_block1
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/D2/individual1
// Hierarchy Level: 3
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module individual1_block1
  ...
  assign Subsystem_out1 = 33'sh000000000;



  assign score = Subsystem_out1;

  Subsystem1_block7 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem2_block7 u_Subsystem2 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem3_block7 u_Subsystem3 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem4_block7 u_Subsystem4 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem5_block7 u_Subsystem5 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block7 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
