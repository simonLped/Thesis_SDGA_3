// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\b2_random.v
...
// 
// Module: b2_random
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/Subsystem/b2_random
// Hierarchy Level: 3
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module b2_random
  ...
  modimpl_ntwk_block2 u_mod_by_constant (.clk(clk),
                                         .reset_x(reset_x),
                                         .enb(enb),
  ...
  assign Add7_out1 = Data_Type_Conversion11_out1 + 18'sb110000000001100010;



  assign Add6_out1 = 18'sb110000000001100010 - Data_Type_Conversion11_out1;
