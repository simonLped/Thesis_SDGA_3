// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\individual1_block.v
...
// -------------------------------------------------------------
// 
// Module: individual1_block
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array1/individual1
// Hierarchy Level: 4
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module individual1_block
  ...
  Subsystem_block6 u_Subsystem (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
  ...
  Subsystem1_block5 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem2_block5 u_Subsystem2 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem3_block5 u_Subsystem3 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem4_block5 u_Subsystem4 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem5_block5 u_Subsystem5 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block5 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
