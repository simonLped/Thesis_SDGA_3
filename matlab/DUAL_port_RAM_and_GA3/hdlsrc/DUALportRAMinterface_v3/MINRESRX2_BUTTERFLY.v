// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\MINRESRX2_BUTTERFLY.v
...
module MINRESRX2_BUTTERFLY
  ...
  wire signed [27:0] intdelay_reg_next_2 [0:7];  // sfix28_En14 [8]
  wire signed [27:0] din1Dly_re;  // sfix28_En14
  reg signed [27:0] intdelay_reg_3 [0:7];  // sfix28 [8]
  wire signed [27:0] intdelay_reg_next_3 [0:7];  // sfix28_En14 [8]
  wire signed [27:0] din1Dly_im;  // sfix28_En14
  reg  [7:0] intdelay_reg_4;  // ufix1 [8]
  wire [7:0] intdelay_reg_next_4;  // ufix1 [8]
  wire din1Dly_vld;
  ...
  always @(posedge clk)
    begin : intdelay_2_process
      if (reset_x == 1'b0) begin
        ...
        intdelay_reg_2[2] <= 28'sb0000000000000000000000000000;
        intdelay_reg_2[3] <= 28'sb0000000000000000000000000000;
        intdelay_reg_2[4] <= 28'sb0000000000000000000000000000;
        intdelay_reg_2[5] <= 28'sb0000000000000000000000000000;
        intdelay_reg_2[6] <= 28'sb0000000000000000000000000000;
        intdelay_reg_2[7] <= 28'sb0000000000000000000000000000;
      end
      else begin
        if (enb) begin
          if (syncReset == 1'b1) begin
  ...
  always @(posedge clk)
    begin : intdelay_3_process
      if (reset_x == 1'b0) begin
        ...
        intdelay_reg_3[2] <= 28'sb0000000000000000000000000000;
        intdelay_reg_3[3] <= 28'sb0000000000000000000000000000;
        intdelay_reg_3[4] <= 28'sb0000000000000000000000000000;
        intdelay_reg_3[5] <= 28'sb0000000000000000000000000000;
        intdelay_reg_3[6] <= 28'sb0000000000000000000000000000;
        intdelay_reg_3[7] <= 28'sb0000000000000000000000000000;
      end
      else begin
        if (enb) begin
          if (syncReset == 1'b1) begin
