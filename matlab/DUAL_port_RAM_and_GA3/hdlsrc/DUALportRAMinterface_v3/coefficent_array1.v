// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\coefficent_array1.v
...
// -------------------------------------------------------------
// 
// Module: coefficent_array1
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array1
// Hierarchy Level: 3
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module coefficent_array1
  ...
  wire signed [32:0] Switch2_out1 [0:6];  // sfix33_En15 [7]
  ...
  wire signed [32:0] Switch3_out1 [0:6];  // sfix33_En15 [7]
  ...
  wire signed [32:0] Switch5_out1 [0:6];  // sfix33_En15 [7]
  ...
  wire signed [32:0] Switch7_out1 [0:6];  // sfix33_En15 [7]
  ...
  wire signed [32:0] Switch6_out1 [0:6];  // sfix33_En15 [7]
  ...
  wire signed [32:0] Switch4_out1 [0:6];  // sfix33_En15 [7]
  ...
  assign Relational_Operator14_out1 = chose_input == 4'b0100;



  assign Relational_Operator13_out1 = chose_input == 4'b0011;



  assign Relational_Operator12_out1 = chose_input == 4'b0010;



  assign Relational_Operator11_out1 = chose_input == 4'b0001;
  ...
  assign Relational_Operator4_out1 = {3'b0, Logical_Operator2_out1} == 4'b0001;
  ...
  assign Relational_Operator10_out1 = commit_swap_1 == 4'b0011;
  ...
  assign Switch7_out1[0] = (switch_compare_1 == 1'b0 ? individual_in[0] :
              Mux3_out1[0]);
  assign Switch7_out1[1] = (switch_compare_1 == 1'b0 ? individual_in[1] :
              Mux3_out1[1]);
  assign Switch7_out1[2] = (switch_compare_1 == 1'b0 ? individual_in[2] :
              Mux3_out1[2]);
  assign Switch7_out1[3] = (switch_compare_1 == 1'b0 ? individual_in[3] :
              Mux3_out1[3]);
  assign Switch7_out1[4] = (switch_compare_1 == 1'b0 ? individual_in[4] :
              Mux3_out1[4]);
  assign Switch7_out1[5] = (switch_compare_1 == 1'b0 ? individual_in[5] :
              Mux3_out1[5]);
  assign Switch7_out1[6] = (switch_compare_1 == 1'b0 ? individual_in[6] :
              Mux3_out1[6]);



  individual4_block u_individual4 (.clk(clk),
                                   .reset_x(reset_x),
                                   .enb(enb),
  ...
  assign Switch6_out1[0] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[0] :
              Mux2_out1[0]);
  assign Switch6_out1[1] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[1] :
              Mux2_out1[1]);
  assign Switch6_out1[2] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[2] :
              Mux2_out1[2]);
  assign Switch6_out1[3] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[3] :
              Mux2_out1[3]);
  assign Switch6_out1[4] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[4] :
              Mux2_out1[4]);
  assign Switch6_out1[5] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[5] :
              Mux2_out1[5]);
  assign Switch6_out1[6] = (switch_compare_1_1 == 1'b0 ? Mux4_out1[6] :
              Mux2_out1[6]);



  assign Relational_Operator9_out1 = commit_swap_2 == 4'b0011;



  assign commit_swap_2 = commit_swap;

  assign Relational_Operator7_out1 = commit_swap_2 == 4'b0010;
  ...
  assign Switch5_out1[0] = (switch_compare_1_2 == 1'b0 ? individual_in[0] :
              Switch6_out1[0]);
  assign Switch5_out1[1] = (switch_compare_1_2 == 1'b0 ? individual_in[1] :
              Switch6_out1[1]);
  assign Switch5_out1[2] = (switch_compare_1_2 == 1'b0 ? individual_in[2] :
              Switch6_out1[2]);
  assign Switch5_out1[3] = (switch_compare_1_2 == 1'b0 ? individual_in[3] :
              Switch6_out1[3]);
  assign Switch5_out1[4] = (switch_compare_1_2 == 1'b0 ? individual_in[4] :
              Switch6_out1[4]);
  assign Switch5_out1[5] = (switch_compare_1_2 == 1'b0 ? individual_in[5] :
              Switch6_out1[5]);
  assign Switch5_out1[6] = (switch_compare_1_2 == 1'b0 ? individual_in[6] :
              Switch6_out1[6]);



  individual3_block u_individual3 (.clk(clk),
                                   .reset_x(reset_x),
                                   .enb(enb),
  ...
  assign Switch4_out1[0] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[0] :
              Mux1_out1[0]);
  assign Switch4_out1[1] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[1] :
              Mux1_out1[1]);
  assign Switch4_out1[2] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[2] :
              Mux1_out1[2]);
  assign Switch4_out1[3] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[3] :
              Mux1_out1[3]);
  assign Switch4_out1[4] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[4] :
              Mux1_out1[4]);
  assign Switch4_out1[5] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[5] :
              Mux1_out1[5]);
  assign Switch4_out1[6] = (switch_compare_1_3 == 1'b0 ? Mux3_out1[6] :
              Mux1_out1[6]);



  assign Relational_Operator8_out1 = commit_swap_3 == 4'b0010;



  assign commit_swap_3 = commit_swap;

  assign Relational_Operator6_out1 = commit_swap_3 == 4'b0001;
  ...
  assign Switch3_out1[0] = (switch_compare_1_4 == 1'b0 ? individual_in[0] :
              Switch4_out1[0]);
  assign Switch3_out1[1] = (switch_compare_1_4 == 1'b0 ? individual_in[1] :
              Switch4_out1[1]);
  assign Switch3_out1[2] = (switch_compare_1_4 == 1'b0 ? individual_in[2] :
              Switch4_out1[2]);
  assign Switch3_out1[3] = (switch_compare_1_4 == 1'b0 ? individual_in[3] :
              Switch4_out1[3]);
  assign Switch3_out1[4] = (switch_compare_1_4 == 1'b0 ? individual_in[4] :
              Switch4_out1[4]);
  assign Switch3_out1[5] = (switch_compare_1_4 == 1'b0 ? individual_in[5] :
              Switch4_out1[5]);
  assign Switch3_out1[6] = (switch_compare_1_4 == 1'b0 ? individual_in[6] :
              Switch4_out1[6]);



  individual2_block u_individual2 (.clk(clk),
                                   .reset_x(reset_x),
                                   .enb(enb),
  ...
  swap_counter_block u_swap_counter (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  swap_counter1_block u_swap_counter1 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  assign Relational_Operator5_out1 = commit_swap_4 == 4'b0001;
  ...
  assign Switch2_out1[0] = (switch_compare_1_5 == 1'b0 ? individual_in[0] :
              Mux2_out1[0]);
  assign Switch2_out1[1] = (switch_compare_1_5 == 1'b0 ? individual_in[1] :
              Mux2_out1[1]);
  assign Switch2_out1[2] = (switch_compare_1_5 == 1'b0 ? individual_in[2] :
              Mux2_out1[2]);
  assign Switch2_out1[3] = (switch_compare_1_5 == 1'b0 ? individual_in[3] :
              Mux2_out1[3]);
  assign Switch2_out1[4] = (switch_compare_1_5 == 1'b0 ? individual_in[4] :
              Mux2_out1[4]);
  assign Switch2_out1[5] = (switch_compare_1_5 == 1'b0 ? individual_in[5] :
              Mux2_out1[5]);
  assign Switch2_out1[6] = (switch_compare_1_5 == 1'b0 ? individual_in[6] :
              Mux2_out1[6]);



  individual1_block u_individual1 (.clk(clk),
                                   .reset_x(reset_x),
                                   .enb(enb),
  ...
  output_selector_block u_output_selector (.chose_port(chose_output),  // ufix4
  ...
  assign elite_individual_0 = individual1_out1;

  assign elite_individual_1 = individual1_out2;

  assign elite_individual_2 = individual1_out3;

  assign elite_individual_3 = individual1_out4;

  assign elite_individual_4 = individual1_out5;

  assign elite_individual_5 = individual1_out6;

  assign elite_individual_6 = individual1_out7;

endmodule  // coefficent_array1
