// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\a3_random.v
...
// 
// Module: a3_random
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/Subsystem/a3_random
// Hierarchy Level: 3
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module a3_random
  ...
  assign Data_Type_Conversion9_out1 = Bit_Shift3_out1[15:5];
  ...
  modimpl_ntwk_block u_mod_by_constant (.clk(clk),
                                        .reset_x(reset_x),
                                        .enb(enb),
  ...
  assign Add7_out1 = Data_Type_Conversion11_out1 + 18'sb001000001110101001;



  assign Add6_out1 = 18'sb001000001110101001 - Data_Type_Conversion11_out1;
