// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA3\hdlsrc\DUALportRAMinterface_v3\individual1.v
...
// 
// Module: individual1
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array/individual1
// Hierarchy Level: 4
// Model version: 1.38
// 
// -------------------------------------------------------------
...
module individual1
  ...
  Subsystem_block2 u_Subsystem (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
  ...
  Subsystem1_block1 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block1 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
