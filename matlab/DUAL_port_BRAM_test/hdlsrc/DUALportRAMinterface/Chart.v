// -------------------------------------------------------------
// 
// File Name: DUAL_port_BRAM_test\hdlsrc\DUALportRAMinterface\Chart.v
...
// 
// Module: Chart
// Source Path: DUALportRAMinterface/BRAM_subsytem_interface_test/Chart
// Hierarchy Level: 1
// Model version: 1.26
// 
// -------------------------------------------------------------
    ...
    case ( is_Chart)
      state_type_is_Chart_IN_PL_read_data :
        begin
          ...
          write_enable_1 = 1'b0;
          if (counter == 16'b0001100000000001) begin
