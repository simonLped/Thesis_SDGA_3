...
PRODUCT_NAME              = DUALportRAMinterface_v3
MAKEFILE                  = DUALportRAMinterface_v3.mk
...
COMPILER_COMMAND_FILE     = DUALportRAMinterface_v3_comp.rsp
CMD_FILE                  = DUALportRAMinterface_v3.rsp
...
PRODUCT = ./DUALportRAMinterface_v3.exe
...
DEFINES_STANDARD = -DMODEL=DUALportRAMinterface_v3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = DUALportRAMinterface_v3.obj DUALportRAMinterface_v3_capi.obj DUALportRAMinterface_v3_data.obj DUALportRAMinterface_v3_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DUALportRAMinterface_v3.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/DUALportRAMinterface_v3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DUALportRAMinterface_v3_capi.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/DUALportRAMinterface_v3_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DUALportRAMinterface_v3_data.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/DUALportRAMinterface_v3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DUALportRAMinterface_v3_tgtconn.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/DUALportRAMinterface_v3_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/DUALportRAMinterface_v3/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
