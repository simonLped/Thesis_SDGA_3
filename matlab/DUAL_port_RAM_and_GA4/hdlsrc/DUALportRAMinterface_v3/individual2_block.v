// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\individual2_block.v
...
// -------------------------------------------------------------
// 
// Module: individual2_block
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array1/individual2
// Hierarchy Level: 4
// Model version: 1.52
// 
// -------------------------------------------------------------
...
module individual2_block
  ...
  Subsystem_block5 u_Subsystem (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
  ...
  Subsystem1_block4 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem2_block4 u_Subsystem2 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem3_block4 u_Subsystem3 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem4_block4 u_Subsystem4 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem5_block4 u_Subsystem5 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block4 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
