// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\modimpl_ntwk_block2.v
...
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/Subsystem/b2_random/modimpl_ntwk
// Hierarchy Level: 4
// Model version: 1.52
// 
// -------------------------------------------------------------
    ...
    begin : multiply_and_extract_fraction_process
      if (reset_x == 1'b0) begin
        ...
        if (enb) begin
          ...
          multiply_and_extract_fraction_invReg0 <= 71'h4CEC4EC4EC4EC5EABF;
        end
      end
    end

  assign Y = multiply_and_extract_fraction_outReg;
  assign multiply_and_extract_fraction_mul_temp = multiply_and_extract_fraction_fracReg * 53'h1A9FBE76C8B439;
