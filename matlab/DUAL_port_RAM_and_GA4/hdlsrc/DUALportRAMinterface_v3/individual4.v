// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\individual4.v
...
// 
// Module: individual4
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array/individual4
// Hierarchy Level: 4
// Model version: 1.52
// 
// -------------------------------------------------------------
...
module individual4
  ...
  Subsystem_block3 u_Subsystem (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
  ...
  Subsystem1_block2 u_Subsystem1 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
  ...
  Subsystem6_block2 u_Subsystem6 (.clk(clk),
                                  .reset_x(reset_x),
                                  .enb(enb),
