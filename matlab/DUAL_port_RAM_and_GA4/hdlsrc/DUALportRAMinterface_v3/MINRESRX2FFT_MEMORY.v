// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\MINRESRX2FFT_MEMORY.v
    ...
    begin : intdelay_4_process
      if (reset_x == 1'b0) begin
        for(intdelay_t_1_3 = 32'sd0; intdelay_t_1_3 <= 32'sd1; intdelay_t_1_3 = intdelay_t_1_3 + 32'sd1) begin
          intdelay_reg_4[intdelay_t_1_3] <= 28'sb0000000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
    ...
    begin : intdelay_5_process
      if (reset_x == 1'b0) begin
        for(intdelay_t_1_4 = 32'sd0; intdelay_t_1_4 <= 32'sd1; intdelay_t_1_4 = intdelay_t_1_4 + 32'sd1) begin
          intdelay_reg_5[intdelay_t_1_4] <= 28'sb0000000000000000000000000000;
        end
      end
      else begin
        if (enb) begin
