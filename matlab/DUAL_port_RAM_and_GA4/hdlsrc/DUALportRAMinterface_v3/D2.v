// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\D2.v
...
module D2
  ...
  wire signed [63:0] zero4_out1;  // sfix64_En32
  wire switch_compare_1_2;
  wire switch_compare_1_3;
  wire signed [63:0] zero5_out1;  // sfix64_En32
  wire signed [63:0] zero6_out1;  // sfix64_En32
  ...
  wire signed [63:0] zero3_out1;  // sfix64_En32
  ...
  assign zero4_out1 = 64'sh0000000000000000;
  ...
  assign zero5_out1 = 64'sh0000000000000000;



  assign zero6_out1 = 64'sh0000000000000000;
  ...
  assign zero3_out1 = 64'sh0000000000000000;
  ...
  assign zero_out1 = 64'sh0000000000000000;
  ...
  assign zero1_out1 = 64'sh0000000000000000;
  ...
  assign zero2_out1 = 64'sh0000000000000000;
