// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\Chart_block1.v
...
// 
// Module: Chart_block1
// Source Path: DUALportRAMinterface_v3/PL/integration_block1/GA_main/coefficent_array1/Chart
// Hierarchy Level: 4
// Model version: 1.52
// 
// -------------------------------------------------------------
...
module Chart_block1
  ...
  // Default encoded enumeration values for type state_type_is_Chart2
  parameter state_type_is_Chart2_IN_done_state1 = 3'd0, state_type_is_Chart2_IN_index_increment1 = 3'd1, state_type_is_Chart2_IN_initial_sort1 = 3'd2, state_type_is_Chart2_IN_not_perform_swap1 = 3'd3, state_type_is_Chart2_IN_perform_swap1 = 3'd4, state_type_is_Chart2_IN_round_increment1 = 3'd5, state_type_is_Chart2_IN_start_round1 = 3'd6;
  ...
  reg  reset_swaps_reg;
  reg [2:0] is_Chart_next;  // enum type state_type_is_Chart2 (7 enums)
  ...
  always @(posedge clk)
    begin : Chart_process
      if (reset_x == 1'b0) begin
        ...
        is_Chart <= state_type_is_Chart2_IN_initial_sort1;
      end
      else begin
        if (enb) begin
  ...
  always @(commit_swap_reg, index, index_increment_reg, index_reset_reg, is_Chart,
    ...
    case ( is_Chart)
      state_type_is_Chart2_IN_done_state1 :
        begin
          is_Chart_next = state_type_is_Chart2_IN_initial_sort1;
        end
      state_type_is_Chart2_IN_index_increment1 :
        begin
          index_increment_reg_next = 1'b0;
          is_Chart_next = state_type_is_Chart2_IN_start_round1;
          reset_swaps_reg_next = 1'b0;
          index_reset_reg_next = 1'b0;
        end
      state_type_is_Chart2_IN_initial_sort1 :
        begin
          if (start_sort) begin
            is_Chart_next = state_type_is_Chart2_IN_start_round1;
            reset_swaps_reg_next = 1'b0;
      ...
      state_type_is_Chart2_IN_not_perform_swap1 :
        begin
          if (index < 4'b0011) begin
            is_Chart_next = state_type_is_Chart2_IN_index_increment1;
            index_increment_reg_next = 1'b1;
          end
          else if (swaps_in == 4'b0000) begin
            is_Chart_next = state_type_is_Chart2_IN_done_state1;
            sort_done_reg_next = 1'b1;
          end
          else if (index == 4'b0011) begin
            is_Chart_next = state_type_is_Chart2_IN_round_increment1;
            index_reset_reg_next = 1'b1;
            reset_swaps_reg_next = 1'b1;
          end
        end
      state_type_is_Chart2_IN_perform_swap1 :
        begin
          if (index == 4'b0011) begin
      ...
      state_type_is_Chart2_IN_round_increment1 :
        begin
          is_Chart_next = state_type_is_Chart2_IN_start_round1;
          reset_swaps_reg_next = 1'b0;
          index_reset_reg_next = 1'b0;
      ...
      default :
        begin
          ...
          if ( ! swap_signal) begin
            is_Chart_next = state_type_is_Chart2_IN_not_perform_swap1;
            commit_swap_reg_next = 4'b0000;
          end
            ...
            is_Chart_next = state_type_is_Chart2_IN_perform_swap1;
  ...
  assign sort_donedeadOut = sort_done_reg_next;
