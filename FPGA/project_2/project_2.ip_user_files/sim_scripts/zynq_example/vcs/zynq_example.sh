...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.zynq_example xil_defaultlib.glbl -o zynq_example_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./zynq_example_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key zynq_example_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc zynq_example_simv.daidir vcs_lib c.obj)
