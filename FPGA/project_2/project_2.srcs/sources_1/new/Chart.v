// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_v2\hdlsrc\DUALportRAMinterface\Chart.v
// Created: 2024-05-01 11:55:19
// 
...
// 
// Module: Chart
// Source Path: DUALportRAMinterface/subsystem/Chart
// Hierarchy Level: 1
// Model version: 1.14
// 
// -------------------------------------------------------------
    ...
    case ( is_Chart)
      state_type_is_Chart_IN_PL_read_data :
        begin
          ...
          write_enable_1 = 1'b0;
          if (counter == 16'b0000000001000000) begin
      ...
      state_type_is_Chart_IN_reset_state :
        begin
          is_Chart_next = state_type_is_Chart_IN_initial_wait_state;
          counter_increment_1 = 1'b0;
          counter_reset_1 = 1'b1;
          write_enable_1 = 1'b0;
        end
