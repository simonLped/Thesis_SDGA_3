// -------------------------------------------------------------
// 
// File Name: DUAL_port_RAM_and_GA4\hdlsrc\DUALportRAMinterface_v3\Chart_block2.v
    ...
    case ( is_Chart)
      state_type_is_Chart4_IN_PL_read_data :
        begin
          ...
          write_enable_1 = 1'b0;
          bram_read_1 = 1'b1;
          if (counter == 32'b00000000000000000011000000000010) begin // signal from BRAM to FIFO
//          if (counter == 32'b00000000000000000000000000000010) begin // signal from BRAM to FIFO
