...
module PL
  ...
  assign Multiport_Switch_out1 = (index_counter_out1 == 32'b00000000000000000000000000000000 ? Constant11_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000001 ? Constant10_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000010 ? Constant1_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000011 ? Constant2_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000100 ? Constant6_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000101 ? Constant7_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000110 ? Constant8_out1 :
              (index_counter_out1 == 32'b00000000000000000000000000000111 ? Constant11_out1 :
              Constant11_out1))))))));
